...
public class ScriptConnectorProvider extends AbstractConnectorProvider {
    ...
    public ServiceDescriptor getDescriptor() {
        ...
        builder.attribute(builder.newAttribute().id("parameters").name("service.parameters.name")
                .description("service.parameters.description").build());
