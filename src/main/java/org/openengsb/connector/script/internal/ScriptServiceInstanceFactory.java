...
public class ScriptServiceInstanceFactory extends AbstractConnectorInstanceFactory<ScriptServiceImpl> {
    ...
    public Connector createNewInstance(String id) {
        ScriptServiceImpl service = new ScriptServiceImpl(id);
    ...
    @Override
    public void doApplyAttributes(ScriptServiceImpl instance, Map<String, String> attributes) {
        if (attributes.containsKey("command")) {
            instance.setCommand(attributes.get("command"));
        }
        if (attributes.containsKey("parameters")) {
            instance.setParameters(attributes.get("parameters"));
        }
    }
